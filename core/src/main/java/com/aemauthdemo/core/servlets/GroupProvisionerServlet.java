 ...
 */
package com.aemauthdemo.core.servlets;
 ...
 * Accessible at: /bin/aem-auth-demo/group-provisioner
 * 
 ...
 * 
 * Usage:
 *   POST /bin/aem-auth-demo/group-provisioner?userId=<userId>&principalName=<principalName>
 *   
 * If no userId is provided, it uses the currently logged-in user.
 */
@Component(service = { Servlet.class })
@SlingServletPaths("/bin/aem-auth-demo/group-provisioner")
